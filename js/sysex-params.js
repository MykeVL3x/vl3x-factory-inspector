/**
 * sysex-params.js - VL3X SysEx Parameter Definitions
 *
 * AUTO-GENERATED FROM gold_standard_reference.json
 * DO NOT EDIT MANUALLY - Run generate_sysex_params.py instead
 *
 * Generated: 2026-02-01 22:46:00
 * Source: gold_standard_reference.json
 * Checksum: bd51da908f17e04b
 *
 * Structure:
 * - VL3X_PARAMS: Category -> Subcategory -> Parameter[]
 * - ENUMS: enum_name -> string[]
 * - GOLD_STANDARD_CHECKSUM: Verify sync with gold_standard
 */

export const GOLD_STANDARD_CHECKSUM = "bd51da908f17e04b";
...
// Helper functions for accessing parameter data
...
export function findParamByOffset(offset) {
  for (const category of Object.keys(VL3X_PARAMS)) {
    for (const subcategory of Object.keys(VL3X_PARAMS[category])) {
      const params = VL3X_PARAMS[category][subcategory];
      const found = params.find(p => p.offset === offset);
      if (found) {
        return { ...found, category, subcategory };
      }
    }
  }
  return null;
