...
export const OFFSET_TO_SYSEX_ID = {
  ...
  16: 100, 17: 101, 18: 102, 19: 104, 20: 105, 21: 106, 22: 107, 23: 108, 24: 109, 25: 110,
  26: 111, 27: 112, 28: 116, 29: 126, 30: 127, 31: 128, 32: 129, 33: 130, 34: 139,
  ...
  273: 737, 274: 738, 275: 739, 276: 740, 277: 742, 278: 743, 279: 744, 280: 747, 281: 748,
  282: 773, 283: 774, 284: 775, 285: 776, 286: 777, 287: 778, 288: 779, 289: 780,
  290: 781, 291: 782, 292: 783, 293: 784,
  // HitControl.Gtr_* (offsets 294-302, sysex_ids 785-793)
  294: 785, 295: 786, 296: 787, 297: 788, 298: 789, 299: 790, 300: 791, 301: 792, 302: 793,
  317: 808, 318: 809, 319: 812, 320: 821, 321: 822,
...
export const SYSTEM_OFFSET_TO_SYSEX_ID = {
  ...
  // INPUT section
  20: 17,    // INPUT.INPUT TYPE
  24: 22,    // INPUT.ROOMSENSE AUTO-DETECT
  27: 25,    // INPUT.LEAD DELAY
  28: 26,    // INPUT.AUX VOCAL CANCEL
  61: 741,   // INPUT.GLOBAL PITCH CORRECT
  68: 848,   // INPUT.LEAD MUTE
  69: 855,   // INPUT.MIC GAIN
  73: 859,   // INPUT.MONITOR GAIN
  74: 860,   // INPUT.AUX GAIN
  124: 1086, // INPUT.MIC CLIP PROTECTION
  139: 1134, // INPUT.USB MODE
  // OUTPUT section
  25: 23,    // OUTPUT.XLR OUTPUT LEVEL
  75: 861,   // OUTPUT.TALK TRIM
  95: 949,   // OUTPUT.USB OUTPUT TRIM
  96: 950,   // OUTPUT.XLR OUTPUT
  140: 1136, // OUTPUT.GUITAR JACK MODE
  // GUITAR section
  21: 19,    // GUITAR.PHASE
  51: 117,   // GUITAR.GATE THRESHOLD
  60: 733,   // GUITAR.SPEAKER SIM ENABLE
  70: 856,   // GUITAR.INPUT GAIN
  94: 930,   // GUITAR.OUTPUT MODE
  // MIDI section
  15: 6,     // MIDI.SPLIT DIRECTION
  16: 7,     // MIDI.SPLIT NOTE
  17: 13,    // MIDI.PITCHBEND RANGE
  18: 14,    // MIDI.TRANSPOSE
  19: 16,    // MIDI.MIDI TEMPO
  58: 132,   // MIDI.VIBRATO BOOST
  138: 1133, // MIDI.MIDI TX DELAY
  // TONE section
  32: 43,    // TONE.SHAPE
  33: 44,    // TONE.WARMTH
  34: 45,    // TONE.SMOOTHING AUTO
  35: 59,    // TONE.COMPRESS
  36: 60,    // TONE.DYNAMICS AUTO
  39: 68,    // TONE.DE-ESS
  49: 113,   // TONE.GATE MODE
  52: 119,   // TONE.GATE LEAD LEVEL
  55: 123,   // TONE.GATE HARMONY LEVEL
  62: 749,   // TONE.TONE
};
